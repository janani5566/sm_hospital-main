            ...
            return ScrollableView(
             ...
             scrollDirection: Axis.horizontal,
              child: SingleChildScrollView(
                ...
                child: DataTable(
                  border: TableBorder.all(width: 1,color: Color.fromARGB(255, 14, 11, 11)),
                  columns: [
                        DataColumn(
                     label: Container(
                       child: Expanded(
                 ...
                 'Status',
                  ...
                  rows: List<DataRow>.generate(
                    ...
                    (index) => DataRow(
                      cells: [
                            DataCell(IconButton(
                    icon: new Icon(Icons.edit,color: Color.fromARGB(255, 48, 22, 97)),
                    onPressed: () {
                   ...
                   perid:perid,ipno:ipno,
                    ...
                    showDialog(context: context,
                     builder: (context) {
                      return Container(
              child: AlertDialog(
                title: Text('Are You Sure to delete this data..??',  style: GoogleFonts.crimsonText(color: Colors.white, fontSize: 17 ,fontWeight:  FontWeight.w800,)),
